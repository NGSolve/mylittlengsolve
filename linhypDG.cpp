...
public:
  ...
  virtual void Do(LocalHeap & lh)
  {
	...
	MappedIntegrationRule<D,D> mir(ir, ma.GetTrafo (i), lh);
	...
	bfi.CalcElementMatrix (fel, ma.GetTrafo(i), mass, lh);
	...
	MappedIntegrationRule<D,D> mir(irt, ma.GetTrafo(elnums[0]), lh);
